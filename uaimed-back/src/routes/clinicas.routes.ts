...
import { vincularMedicoSchema, responderSolicitacaoSchema } from '../schemas/clinica.schema';
...
router.post('/clinicas/me/medicos', authMiddleware, requireRole(TipoUsuario.clinica), validateBody(vincularMedicoSchema), (req, res) =>
...
router.patch('/clinicas/solicitacoes/:clinicaId', authMiddleware, requireRole(TipoUsuario.medico), validateBody(responderSolicitacaoSchema), (req, res) =>
